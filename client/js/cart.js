...
const displayCart = () => {
  ...
  if (cart.length > 0) {
    ...
    //mp;
    const mercadopago = new MercadoPago("TEST-0116be59-b8cd-4f83-b964-a20f39ec5299", {
      locale: "es-AR",
    });
    ...
    checkoutButton.addEventListener("click", () => {
      ...
      const orderData = {
        quantity: 1,
        description: "Compra de ecomnerce",
        price: total,
      };
    ...
    modaltext.innerText = "No se encuentran productos agregados en el carrito";
